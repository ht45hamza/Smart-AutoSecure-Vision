...
const Contacts = ({ user }) => {
    ...
    return (
        <div className="p-4 overflow-auto custom-scrollbar flex-grow-1 h-100 bg-dark-theme text-light">
                        ...
                        <div className="col-md-6 col-lg-4" key={c._id}>
                            <div className="card bg-panel border-secondary h-100 shadow-sm hover-elevate transition-all group">
                                <div className="card-body d-flex align-items-center gap-3">
                                    ...
                                    {(user?.role === 'admin' || user?.role === 'manager') && (
                                        <button
                                            className="btn btn-outline-danger btn-sm rounded-circle border-0 bg-transparent hover-bg-danger hover-text-white"
            ...
            {showAddModal && (
                <div className="modal show d-block" style={{ backgroundColor: 'rgba(0,0,0,0.85)', backdropFilter: 'blur(5px)', zIndex: 2000 }}>
